...
const file_qot_Qot_GetPriceReminder_proto_rawDesc = "" +
	"\n" +
	"\x1eqot/Qot_GetPriceReminder.proto\x12\x14Qot_GetPriceReminder\x1a\x13common/Common.proto\x1a\x1bqot/common/Qot_Common.proto\"\xc5\x01\n" +
...
var (
	...
	file_qot_Qot_GetPriceReminder_proto_rawDescData []byte
)

func file_qot_Qot_GetPriceReminder_proto_rawDescGZIP() []byte {
	file_qot_Qot_GetPriceReminder_proto_rawDescOnce.Do(func() {
		file_qot_Qot_GetPriceReminder_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_qot_Qot_GetPriceReminder_proto_rawDesc), len(file_qot_Qot_GetPriceReminder_proto_rawDesc)))
	})
...
var file_qot_Qot_GetPriceReminder_proto_goTypes = []any{
...
func file_qot_Qot_GetPriceReminder_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_qot_Qot_GetPriceReminder_proto_rawDesc), len(file_qot_Qot_GetPriceReminder_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
