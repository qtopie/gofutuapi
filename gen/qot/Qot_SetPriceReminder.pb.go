...
const file_qot_Qot_SetPriceReminder_proto_rawDesc = "" +
	"\n" +
	"\x1eqot/Qot_SetPriceReminder.proto\x12\x14Qot_SetPriceReminder\x1a\x13common/Common.proto\x1a\x1bqot/common/Qot_Common.proto\"\xdd\x01\n" +
	"\x03C2S\x120\n" +
...
var (
	...
	file_qot_Qot_SetPriceReminder_proto_rawDescData []byte
)

func file_qot_Qot_SetPriceReminder_proto_rawDescGZIP() []byte {
	file_qot_Qot_SetPriceReminder_proto_rawDescOnce.Do(func() {
		file_qot_Qot_SetPriceReminder_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_qot_Qot_SetPriceReminder_proto_rawDesc), len(file_qot_Qot_SetPriceReminder_proto_rawDesc)))
	})
...
var file_qot_Qot_SetPriceReminder_proto_goTypes = []any{
...
func file_qot_Qot_SetPriceReminder_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_qot_Qot_SetPriceReminder_proto_rawDesc), len(file_qot_Qot_SetPriceReminder_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
