...
// 	protoc        (unknown)
// source: qot/qotgetoptionchain/Qot_GetOptionChain.proto
...
func (OptionCondType) Descriptor() protoreflect.EnumDescriptor {
	return file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_enumTypes[0].Descriptor()
}

func (OptionCondType) Type() protoreflect.EnumType {
	return &file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_enumTypes[0]
}
...
func (OptionCondType) EnumDescriptor() ([]byte, []int) {
	return file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_rawDescGZIP(), []int{0}
}
...
func (x *DataFilter) Reset() {
	*x = DataFilter{}
	mi := &file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_msgTypes[0]
...
type C2S struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	Owner           *common.Security       `protobuf:"bytes,1,req,name=owner" json:"owner,omitempty"`                      //期权标的股，目前仅支持传入港美正股以及恒指国指
...
func (x *C2S) Reset() {
	*x = C2S{}
	mi := &file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*C2S) Descriptor() ([]byte, []int) {
	return file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_rawDescGZIP(), []int{1}
}
...
type OptionItem struct {
	state         protoimpl.MessageState     `protogen:"open.v1"`
	Call          *common.SecurityStaticInfo `protobuf:"bytes,1,opt,name=call" json:"call,omitempty"` //看涨期权，不一定有该字段，由请求条件决定
	Put           *common.SecurityStaticInfo `protobuf:"bytes,2,opt,name=put" json:"put,omitempty"`   //看跌期权，不一定有该字段，由请求条件决定
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *OptionItem) Reset() {
	*x = OptionItem{}
	mi := &file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OptionItem) Descriptor() ([]byte, []int) {
	return file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_rawDescGZIP(), []int{2}
}

func (x *OptionItem) GetCall() *common.SecurityStaticInfo {
	if x != nil {
		return x.Call
	}
	return nil
...
func (x *OptionItem) GetPut() *common.SecurityStaticInfo {
	if x != nil {
		return x.Put
	}
	return nil
...
func (x *OptionChain) Reset() {
	*x = OptionChain{}
	mi := &file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OptionChain) Descriptor() ([]byte, []int) {
	return file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_rawDescGZIP(), []int{3}
}
...
func (x *S2C) Reset() {
	*x = S2C{}
	mi := &file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*S2C) Descriptor() ([]byte, []int) {
	return file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_rawDescGZIP(), []int{4}
}
...
func (x *Request) Reset() {
	*x = Request{}
	mi := &file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Request) Descriptor() ([]byte, []int) {
	return file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_rawDescGZIP(), []int{5}
}
...
func (x *Response) Reset() {
	*x = Response{}
	mi := &file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_rawDescGZIP(), []int{6}
}
...
var File_qot_qotgetoptionchain_Qot_GetOptionChain_proto protoreflect.FileDescriptor

const file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_rawDesc = "" +
	"\n" +
	".qot/qotgetoptionchain/Qot_GetOptionChain.proto\x12\x12Qot_GetOptionChain\x1a\x13common/Common.proto\x1a\x1bqot/common/Qot_Common.proto\"\xe4\x04\n" +
	"\n" +
	"DataFilter\x122\n" +
	...
	"\x16OptionCondType_Outside\x10\x02BL\n" +
	"\x13com.futu.openapi.pbZ5github.com/qtopie/gofutuapi/gen/qot/qotgetoptionchain"

var (
	file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_rawDescOnce sync.Once
	file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_rawDescData []byte
)

func file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_rawDescGZIP() []byte {
	file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_rawDescOnce.Do(func() {
		file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_rawDesc), len(file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_rawDesc)))
	})
	return file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_rawDescData
}

var file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_goTypes = []any{
	...
	(*common.Security)(nil),           // 8: Qot_Common.Security
	(*common.SecurityStaticInfo)(nil), // 9: Qot_Common.SecurityStaticInfo
}
var file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_depIdxs = []int32{
...
func init() { file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_init() }
func file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_init() {
	if File_qot_qotgetoptionchain_Qot_GetOptionChain_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_rawDesc), len(file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_goTypes,
		DependencyIndexes: file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_depIdxs,
		EnumInfos:         file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_enumTypes,
		MessageInfos:      file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_msgTypes,
	}.Build()
	File_qot_qotgetoptionchain_Qot_GetOptionChain_proto = out.File
	file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_goTypes = nil
	file_qot_qotgetoptionchain_Qot_GetOptionChain_proto_depIdxs = nil
}
