...
var (
	...
	file_qot_Qot_GetFutureInfo_proto_rawDescData []byte
)

func file_qot_Qot_GetFutureInfo_proto_rawDescGZIP() []byte {
	file_qot_Qot_GetFutureInfo_proto_rawDescOnce.Do(func() {
		file_qot_Qot_GetFutureInfo_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_qot_Qot_GetFutureInfo_proto_rawDesc), len(file_qot_Qot_GetFutureInfo_proto_rawDesc)))
	})
...
var file_qot_Qot_GetFutureInfo_proto_goTypes = []any{
...
func file_qot_Qot_GetFutureInfo_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_qot_Qot_GetFutureInfo_proto_rawDesc), len(file_qot_Qot_GetFutureInfo_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
