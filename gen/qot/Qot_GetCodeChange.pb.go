...
const file_qot_Qot_GetCodeChange_proto_rawDesc = "" +
	"\n" +
	"\x1bqot/Qot_GetCodeChange.proto\x12\x11Qot_GetCodeChange\x1a\x13common/Common.proto\x1a\x1bqot/common/Qot_Common.proto\"\xf4\x02\n" +
...
var (
	...
	file_qot_Qot_GetCodeChange_proto_rawDescData []byte
)

func file_qot_Qot_GetCodeChange_proto_rawDescGZIP() []byte {
	file_qot_Qot_GetCodeChange_proto_rawDescOnce.Do(func() {
		file_qot_Qot_GetCodeChange_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_qot_Qot_GetCodeChange_proto_rawDesc), len(file_qot_Qot_GetCodeChange_proto_rawDesc)))
	})
...
var file_qot_Qot_GetCodeChange_proto_goTypes = []any{
...
func file_qot_Qot_GetCodeChange_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_qot_Qot_GetCodeChange_proto_rawDesc), len(file_qot_Qot_GetCodeChange_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
