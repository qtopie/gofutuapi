...
type DetailItem struct {
	...
	Security         *common.Security       `protobuf:"bytes,1,req,name=security" json:"security,omitempty"`                  //拉取的股票
...
const file_qot_qotrequesthistoryklquota_Qot_RequestHistoryKLQuota_proto_rawDesc = "" +
	...
	"\x03s2c\x18\x04 \x01(\v2\x1e.Qot_RequestHistoryKLQuota.S2CR\x03s2cBS\n" +
