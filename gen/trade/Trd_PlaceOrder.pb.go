...
const file_trade_Trd_PlaceOrder_proto_rawDesc = "" +
	"\n" +
	"\x1atrade/Trd_PlaceOrder.proto\x12\x0eTrd_PlaceOrder\x1a\x13common/Common.proto\x1a\x16trade/Trd_Common.proto\"\xbe\x04\n" +
	"\x03C2S\x12,\n" +
...
var (
	...
	file_trade_Trd_PlaceOrder_proto_rawDescData []byte
)

func file_trade_Trd_PlaceOrder_proto_rawDescGZIP() []byte {
	file_trade_Trd_PlaceOrder_proto_rawDescOnce.Do(func() {
		file_trade_Trd_PlaceOrder_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_trade_Trd_PlaceOrder_proto_rawDesc), len(file_trade_Trd_PlaceOrder_proto_rawDesc)))
	})
...
var file_trade_Trd_PlaceOrder_proto_goTypes = []any{
...
func file_trade_Trd_PlaceOrder_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_trade_Trd_PlaceOrder_proto_rawDesc), len(file_trade_Trd_PlaceOrder_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
