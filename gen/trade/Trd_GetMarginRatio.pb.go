...
var (
	...
	file_trade_Trd_GetMarginRatio_proto_rawDescData []byte
)

func file_trade_Trd_GetMarginRatio_proto_rawDescGZIP() []byte {
	file_trade_Trd_GetMarginRatio_proto_rawDescOnce.Do(func() {
		file_trade_Trd_GetMarginRatio_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_trade_Trd_GetMarginRatio_proto_rawDesc), len(file_trade_Trd_GetMarginRatio_proto_rawDesc)))
	})
...
var file_trade_Trd_GetMarginRatio_proto_goTypes = []any{
...
func file_trade_Trd_GetMarginRatio_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_trade_Trd_GetMarginRatio_proto_rawDesc), len(file_trade_Trd_GetMarginRatio_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
