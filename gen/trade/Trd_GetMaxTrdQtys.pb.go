...
const file_trade_Trd_GetMaxTrdQtys_proto_rawDesc = "" +
	"\n" +
	"\x1dtrade/Trd_GetMaxTrdQtys.proto\x12\x11Trd_GetMaxTrdQtys\x1a\x13common/Common.proto\x1a\x16trade/Trd_Common.proto\"\xa4\x02\n" +
	"\x03C2S\x12-\n" +
...
var (
	...
	file_trade_Trd_GetMaxTrdQtys_proto_rawDescData []byte
)

func file_trade_Trd_GetMaxTrdQtys_proto_rawDescGZIP() []byte {
	file_trade_Trd_GetMaxTrdQtys_proto_rawDescOnce.Do(func() {
		file_trade_Trd_GetMaxTrdQtys_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_trade_Trd_GetMaxTrdQtys_proto_rawDesc), len(file_trade_Trd_GetMaxTrdQtys_proto_rawDesc)))
	})
...
var file_trade_Trd_GetMaxTrdQtys_proto_goTypes = []any{
...
func file_trade_Trd_GetMaxTrdQtys_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_trade_Trd_GetMaxTrdQtys_proto_rawDesc), len(file_trade_Trd_GetMaxTrdQtys_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
